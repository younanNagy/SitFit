...
while(True):
    ...
    if len(contours):
        ...
        cv2.putText(new_frame, "area: "+str(cv2.contourArea(c)) , (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)

        cv2.putText(new_frame, "(" + str(cX) + "," + str(cY)+")", (cX - 20, cY - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
     # Display the resulting frame
    cv2.imshow('frame',new_frame)
